...
@php
    $title = 'Tambah Petugas Medis Baru';
    ...
    <div class="row gy-4">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('medical_personnel.store') }}" method="POST" class="row gy-3 needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field has-validation">
                                <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
                                    ...
                                    <option value="perawat" {{ old('category') == 'perawat' ? 'selected' : '' }}>Perawat</option>
                                    <option value="petugas" {{ old('category') == 'petugas' ? 'selected' : '' }}>Petugas</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <input type="text" id="nik" name="nik" class="form-control @error('nik') is-invalid @enderror" placeholder="NIK Petugas Medis Anda" value="{{ old('nik') }}" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nama Petugas Medis" value="{{ old('name') }}" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field">
                                ...
                                <input type="text" id="specialization" name="specialization" class="form-control @error('specialization') is-invalid @enderror" placeholder="Bagian pekerjaan atau spesialisasi" value="{{ old('specialization') }}">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="icon-field">
                                ...
                                <textarea id="address" name="address" class="form-control @error('address') is-invalid @enderror" placeholder="Alamat tinggal petugas medis Anda">{{ old('address') }}</textarea>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field">
                                ...
                                <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email aktif petugas medis" value="{{ old('email') }}">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                            <button class="btn btn-primary-600" type="submit">Simpan Petugas Medis</button>
