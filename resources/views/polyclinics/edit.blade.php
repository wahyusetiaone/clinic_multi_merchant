    ...
    <div class="row gy-4">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('polyclinics.update', $polyclinic->id) }}" method="POST" class="row gy-3 needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <input type="text" id="code" name="code" class="form-control" value="{{ old('code', $polyclinic->code) }}" placeholder="Contoh: G, UM, ANAK" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <input type="text" id="name" name="name" class="form-control" value="{{ old('name', $polyclinic->name) }}" placeholder="Contoh: Poli Gigi, Poli Umum" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <select id="branch_id" name="branch_id" class="form-select" required>
                                    ...
                                    @foreach ($branches as $branch)
                                        <option value="{{ $branch->id }}" {{ old('branch_id', $polyclinic->branch_id) == $branch->id ? 'selected' : '' }}>{{ $branch->name }} ({{ $branch->organization->name ?? '' }})</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback">
                                    Mohon pilih cabang.
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <input type="text" id="physical_location_type" name="physical_location_type" class="form-control" value="{{ old('physical_location_type', $polyclinic->physical_location_type) }}" placeholder="Contoh: Ruang 101, Gedung B">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <textarea id="description" name="description" class="form-control" placeholder="Keterangan singkat tentang poli ini">{{ old('description', $polyclinic->description) }}</textarea>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                            <button class="btn btn-primary-600" type="submit">Update Poli Klinik</button>
