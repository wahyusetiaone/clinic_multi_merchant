    ...
    <div class="row gy-4">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('employees.store') }}" method="POST" class="row gy-3 needs-validation" novalidate>
                        @csrf
                            ...
                            <div class="icon-field has-validation">
                                <select id="branch_id" name="branch_id" class="form-select">
                                    ...
                                    @foreach ($branches as $branch)
                                        <option value="{{ $branch->id }}" {{ old('branch_id') == $branch->id ? 'selected' : '' }}>{{ $branch->name }} ({{ $branch->type }})</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <input type="text" id="nip" name="nip" class="form-control" value="{{ old('nip') }}" placeholder="Contoh: 199001012020121001">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <input type="text" id="phone" name="phone" class="form-control" value="{{ old('phone') }}" placeholder="+62 812-3456-7890">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <textarea id="address" name="address" class="form-control" placeholder="Alamat Lengkap">{{ old('address') }}</textarea>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <input type="email" id="email" name="email" class="form-control" value="{{ old('email') }}" placeholder="email@example.com">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            <label for="password" class="form-label">Password Akun (Opsional, min 8 karakter)</label>
                            <div class="icon-field has-validation">
                        ...
                        <div class="col-12">
                            <button class="btn btn-primary-600" type="submit">Simpan Pegawai</button>
