    ...
    <div class="row gy-4">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('doctors.update', $doctor->id) }}" method="POST" enctype="multipart/form-data" class="row gy-3 needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <input type="text" id="nik" name="nik" class="form-control @error('nik') is-invalid @enderror" placeholder="NIK Dokter Anda" value="{{ old('nik', $doctor->nik) }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field">
                                ...
                                <input type="text" id="satusehat_id" name="satusehat_id" class="form-control @error('satusehat_id') is-invalid @enderror" placeholder="ID Satu Sehat (Jika terhubung)" value="{{ old('satusehat_id', $doctor->satusehat_id) }}">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nama Dokter" value="{{ old('name', $doctor->name) }}" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field">
                                ...
                                <input type="text" id="specialization" name="specialization" class="form-control @error('specialization') is-invalid @enderror" placeholder="Spesialis / Keahlian Dokter" value="{{ old('specialization', $doctor->specialization) }}">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="icon-field">
                                ...
                                <textarea id="address" name="address" class="form-control @error('address') is-invalid @enderror" placeholder="Alamat tinggal dokter Anda">{{ old('address', $doctor->address) }}</textarea>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field">
                                ...
                                <input type="text" id="phone_number" name="phone_number" class="form-control @error('phone_number') is-invalid @enderror" placeholder="Nomor telepon yang bisa dihubungi" value="{{ old('phone_number', $doctor->phone_number) }}">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field">
                                ...
                                <input type="text" id="str_number" name="str_number" class="form-control @error('str_number') is-invalid @enderror" placeholder="Nomor Surat Tanda Registrasi" value="{{ old('str_number', $doctor->str_number) }}">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field">
                                ...
                                <input type="text" id="username" name="username" class="form-control @error('username') is-invalid @enderror" placeholder="Username untuk login dokter" value="{{ old('username', $doctor->username) }}">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <input type="date" id="start_date" name="start_date" class="form-control @error('start_date') is-invalid @enderror" value="{{ old('start_date', $doctor->start_date->format('Y-m-d')) }}" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($doctor->photo)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($doctor->photo) }}" alt="Foto Dokter" style="max-width: 150px; height: auto;">
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($doctor->signature)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($doctor->signature) }}" alt="Tanda Tangan Dokter" style="max-width: 150px; height: auto;">
                                    <p class="text-muted">Tanda tangan saat ini</p>
                                </div>
                            @endif
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($doctor->stamp)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($doctor->stamp) }}" alt="Stempel Dokter" style="max-width: 150px; height: auto;">
                                    <p class="text-muted">Stempel saat ini</p>
                                </div>
                            @endif
                        ...
                        <div class="col-12">
                            <button class="btn btn-primary-600" type="submit">Update Dokter</button>
