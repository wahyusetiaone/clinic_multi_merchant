    ...
    <div class="row gy-4">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('units.store') }}" method="POST" class="row gy-3 needs-validation" novalidate>
                        @csrf
                        <div class="col-md-12">
                            ...
                            <div class="icon-field has-validation">
                                ...
                                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nama Satuan Obat (contoh: Tablet, Box)" value="{{ old('name') }}" required>
                        ...
                        <div class="col-12">
                            <button class="btn btn-primary-600" type="submit">Simpan Satuan</button>
